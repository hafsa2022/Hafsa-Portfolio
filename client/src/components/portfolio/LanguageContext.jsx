...
const translations = {
  fr: {
    ...
    about: {
      ...
      bio1: "Je suis Hafsa EL AKHDAR, une ingénieure passionnée par la géoinformation et le développement web. Mon parcours combine l'expertise en Systèmes d'Information Géographique (SIG) avec les compétences en développement Full Stack.",
